...
print(f'''decisão final:  
      ...
      produto prioritario {produto_receita}
      
      Justificativa:
      
      O produto apresenta o maior faturamnent entre todos.
      ...
      5 - COMPARAR OS RESULTADOS APÓS A ESTRATÉGIA APLCAIDA      
...
print('''CONCLUSÃO: 
      ...
      - > pega os número e transforma em evidências. 
